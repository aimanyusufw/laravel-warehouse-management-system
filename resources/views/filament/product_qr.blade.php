                ...
                <tr>
                    <td class="info-left">
                        <div>
                            ...
                            <h2 class="title">{{ $product->sku }}</h2>
                            <h2 class="subtitle">{{ $product->unit }}</h2>
                            <h3 class="subtitle">{{ $product->capacity }}</h3>
                        </div>
                    </td>

                    <td class="info-right">
                        <img src="{{ public_path('storage/' . $product->qr_code_path) }}" alt="QR Code" class="qr-img">
                    </td>
                </tr>
            </table>
